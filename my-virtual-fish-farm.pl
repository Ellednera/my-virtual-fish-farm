...
#use Win32::Console::ANSI; # needed for compiling under Windows
...
while ( "fish are swimming happily" ) {
    ...
    print colored(['bold bright_blue'], "Do you want to feed fish? (y/n):[n] ");
    chomp ( my $feed_fish = <>);
    ...
    if ( $feed_fish eq "y" ) {
        ...
        say "You chose to feed the fish instead of waiting for the timer";
